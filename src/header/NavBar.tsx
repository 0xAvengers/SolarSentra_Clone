...
export default function index({ stickyCursorRef }: { stickyCursorRef: any }) {
  const [isActive, setIsActive] = useState(false);

  return (
    <div className={styles.header} style={{ zIndex: 100 }}>
      <div className={styles.bar}>
        <Link href="/">SOLARSENTRA</Link>
        <Magnetic>
          <div
            onClick={() => {
          ...
          >
            ...
            <div ref={stickyCursorRef} className={styles.bounds}></div>
          </div>
        </Magnetic>
        {/* <motion.div
          variants={opacity}
